<!--
================================================================
  Chetan Kumar Rohilla's GitHub Profile README
  Theme: Cyberpunk / Tokyonight Aesthetic
================================================================
-->
...
```yaml
developer:
  name: Chetan Kumar Rohilla
  role: AI / Machine Learning Engineer & Data Scientist
  passions: [Deep Learning, Computer Vision, Speech Processing, ML Automation]
  location: India 🇮🇳
  currently_building: AI Creditworthiness & Speech Emotion Recognition Models
  goals: "Crafting impactful end-to-end AI applications that bridge data & real-world solutions"
```

- 🔭 **Current Focus**: Machine Learning models for financial risk assessment & speech emotion processing.
- 🌱 **Learning & Exploring**: Scalable MLOps pipelines, Transformer architectures, & interactive AI web apps.
- 💬 **Ask me about**: Python, Pandas, Scikit-Learn, PyTorch/TensorFlow, Streamlit, ML algorithms.
- ⚡ **Fun Fact**: I love turning raw datasets into interactive, intelligent decision systems!
...
<div align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/Chetankumarrohi/Chetankumarrohi/output/github-contribution-grid-snake-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/Chetankumarrohi/Chetankumarrohi/output/github-contribution-grid-snake.svg">
    <img alt="github contribution snake grid" src="https://raw.githubusercontent.com/Chetankumarrohi/Chetankumarrohi/output/github-contribution-grid-snake-dark.svg" width="100%">
  </picture>
</div>
...
<div align="center">
  ...
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=python,cpp,html,css,js,git,github,vscode,docker,linux&perline=10" alt="Languages and Core Tools" />
  </a>
...
<div align="center">
  <sub>Designed with ❤️ for <b>Chetan Kumar Rohilla</b> | Star ⭐ this repository if you like it!</sub>
</div>
